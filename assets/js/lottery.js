...
const CATEGORIES = [
    { label: "b p m f",        id: "شفوي",   img: "assets/img/bpmf.png" },
    { label: "d t n l",        id: "لثوي",   img: "assets/img/dtnl.png" },
    { label: "zhi chi shi ri", id: "مطبق",   img: "assets/img/zhchshr.png" },
    { label: "j q x",          id: "غاري",   img: "assets/img/jqx.png" },
    { label: "g k h",          id: "طبقي",   img: "assets/img/gkh.png" },
    { label: "z c s",          id: "أسناني", img: "assets/img/zcs.png" }
];

const TONES = [
    { label: "الأولى",  id: "¯", img: "assets/img/first.png"  },
    { label: "الثانية", id: "ˊ", img: "assets/img/second.png" },
    { label: "الثالثة", id: "ˇ", img: "assets/img/third.png"  },
    { label: "الرابعة", id: "ˋ", img: "assets/img/fourth.png" }
];

const FINALS = [
    { label: "a وأخواتها", id: "ai an ang ao",                              img: "assets/img/a.png" },
    { label: "o وأخواتها", id: "ong ou",                                     img: "assets/img/o.png" },
    { label: "e وأخواتها", id: "ei en eng er",                               img: "assets/img/e.png" },
    { label: "i وأخواتها", id: "ia iao ian iang  ie in ing iong iou",        img: "assets/img/i.png" },
    { label: "u وأخواتها", id: "ua uai uan uang  uei uen ueng uo",          img: "assets/img/u.png" },
    { label: "ü وأخواتها", id: "üe üan ün",                                  img: "assets/img/ü.png" }
];
